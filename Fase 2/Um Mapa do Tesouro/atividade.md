...
## 🎯 Benefícios ao concluir essa Fase 2

Este desafio permitirá que você e seu grupo aplique conhecimentos em sensoriamento, IoT, consulta de API e Data Science. Além disso, trará uma visão prática do uso da IoT e da IA para otimização de recursos em um ambiente agrícola.
...
Organizar os arquivos no seu **GitHub** seguindo uma estrutura de pastas organizada:

1. Organizar os arquivos fonte no seu GitHub, separando no seu Git, um repositório. Por exemplo: meugit/cursotiaor/pbl/fase3/pastas
2. Anexar ao Git o **README.MD** feito em markdown que explica todo o funcionamento do projeto, documentando toda a lógica e especificidades
3. Anexar ao README.MD as **imagens do circuito** da plataforma Wokwi.com que demonstre as conexões dos sensores solicitados
4. Anexar ao Git o **código C/C++** desenvolvido no ESP32
5. Anexar os **códigos do Programa Ir Além** (opcionais 1 e/ou 2)
6. Anexar ao Git o link de um **vídeo de até 5 minutos** postado no YouTube (sem listagem), demonstrando o funcionamento completo de seu projeto referente ao que foi solicitado aqui
